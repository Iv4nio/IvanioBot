...
module.exports = {
    ...
    async execute(message, args, client) {
            ...
            if (!message.member.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return message.channel.send('You do not have the fucking permission to clear messages!');
            if(!message.guild.me.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return message.channel.send('Gimme fucking permissions to clear messages');
