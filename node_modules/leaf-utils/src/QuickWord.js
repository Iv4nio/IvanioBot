...
try {
	...
	if (!options.embed.title) {
		options.embed.title = 'Quick Find | Leaf';
	}
	...
	if (typeof options.backgroundhex !== 'string') {
		throw new TypeError('Leaf-utils: backgroundhex must be a string.');
	}
	...
	if(typeof options.texthex !== 'string') {
		throw new TypeError('Leaf-utils: texthex must be a string.');
	}
	...
	if(typeof options.textlength !== 'number') {
		throw new TypeError('Leaf-utils: textlength must be a number.');
	}
	...
	if (typeof options.waitMessage !== 'string') {
		throw new TypeError('Leaf-utils: waitMessage must be a string.');
	}
	...
	if (typeof options.emoji !== 'string') {
		throw new TypeError('Leaf-utils: emoji must be a string.');
	}
	...
	setTimeout(async function() {
        ...
        console.log(`Error Occured | QuickWord | Error: ${err.stack}`)
    }
};