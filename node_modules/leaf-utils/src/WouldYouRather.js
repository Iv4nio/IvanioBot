...
module.exports = async (options) => {
  try {
	...
	if (!options.embed.title) {
		options.embed.title = 'Would you rather | Leaf';
	}
	...
	if (typeof options.buttons.optionA !== 'string') {
		throw new TypeError('Leaf-utils: button must be a string.');
	}
	...
	gameCollector.on('collect', async (wyr) => {
        ...
        console.log(`Error Occured | WouldYouRather | Error: ${err.stack}`)
    }
};