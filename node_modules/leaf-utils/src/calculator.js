...
try {
	...
	if (!options.embed.title) {
		options.embed.title = 'Calculator | Leaf';
	}
	...
	if (typeof options.disabledQuery !== 'string') {
		throw new TypeError('Leaf-utils: disabledQuery must be a string.');
	}
	...
	if (typeof options.invalidQuery !== 'string') {
		throw new TypeError('Leaf-utils: invalidQuery must be a string.');
	}
